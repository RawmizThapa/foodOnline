...
class UserProfile(models.Model):
    ...
    cover_pictures = models.ImageField(upload_to = 'users/cover_pictures', blank = True, null = True)
    address_line_1 = models.CharField(max_length = 15, blank = True, null = True)
